...
AppBar topNavigationBar (BuildContext context, GlobalKey <ScaffoldState> key) =>
    AppBar (      //when the screen is small switch from logo to icon button
      ...
      Row(
        ...
        key.currentState!.openDrawer();      //openDrawer must be non-nullable
      },),
      elevation: 0,
      title: Row(
        children: [
          ...
          CustomText(text: "Dennis Müller",color: lightGrey,),
